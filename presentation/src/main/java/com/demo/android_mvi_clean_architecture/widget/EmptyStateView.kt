...
@Composable
fun PreviewEmptyStateView() = PreviewContainer {
    Surface {
        EmptyStateView(
            icon = EmptyStateIcon(iconRes = R.drawable.bg_empty_favorite),
            title = stringResource(R.string.no_favorite_movies_title),
            subTitle = stringResource(R.string.no_favorite_movies_subtitle)
        )
    }
}